...
public class AnalyseControllerTest {
    ...
    public void testCreateAnalyse() throws Exception {
        ...
        AnalyseDTO inputAnalyseDTO = new AnalyseDTO("Analyse Libelle", LocalDate.of(2024,10,21), LocalDate.of(2024,12,21), Arrays.asList(new Teste()), echantillonDTO, userLabDTO, patientDTO, reactifDTO);
